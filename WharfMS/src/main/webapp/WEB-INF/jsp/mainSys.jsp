...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header"style="background-color:#2D93CA"  >
        <div class="layui-logo" style="color: #E6E6E6">码头管理系统</div>
        <!-- 头部区域（可配合layui已有的水平导航） -->
        <ul class="layui-nav layui-layout-left">
            <li class="layui-nav-item"><a href="">控制台</a></li>
<%--            <li class="layui-nav-item"><a href="">商品管理</a></li>--%>
            <li class="layui-nav-item"><a href="#" onclick="showPage('/User/showUserList');">用户</a></li>
    ...
    <div class="layui-side " style="background-color: #2D93CA">
...
<%--                        <dd><a href="#" onclick="showPage('/Container/page3');">列表二</a></dd>--%>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;">配套装卸</a>
                    <dl class="layui-nav-child">
                        <dd><a href="#" onclick="showPage('/Matching/showLoad');">装载货柜</a></dd>
                        <dd><a href="#" onclick="showPage('/Matching/showDischarge');">卸载货柜</a></dd>
<%--                        <dd><a href="#" onclick="showPage('/News/page3');">超链接</a></dd>--%>
                    </dl>
                </li>
                <li class="layui-nav-item">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="#" onclick="showPage('/User/showUserList');">用户列表</a></dd>
                        <dd><a href="#" onclick="showPage('/User/showAddUser');">添加管理员</a></dd>
<%--                        <dd><a href="#" onclick="showPage('/User/showUpdateUser');">更新用户</a></dd>--%>
                    </dl>
                </li>
            </ul>
        </div>
