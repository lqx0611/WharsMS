    ...
    layui.use(
        ...
        function(){
            ...
            table.render({
                ...
                ,cols: [[     //设置表头
                    {type: 'checkbox', width:120,fixed: 'left'}
                    ,{field: 'id', title: 'ID', width:120, sort: true, fixed: 'left'}
                    ,{field: 'account', title: '账号', width:200}
                    ,{field: 'name', title: '用户名', width: 200, sort: true, totalRow: true}
                    ,{field: 'createDate', title: '创建时间', width: 250, sort: true, totalRow: true}
                    ,{field: 'role', title: '角色名', width:180}
