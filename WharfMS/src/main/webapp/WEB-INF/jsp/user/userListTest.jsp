...
<head>
    ...
    <link rel="stylesheet" href="${ctxPath}/layui/css/layui.css?t=1586046995289" media="all">
    <style>
        body{margin: 10px;}
...
<script src="${ctxPath}/layui/dist/layui.js?t=1586046995289"></script>
<script>
    layui.config({
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function(){
        ...
        table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: '_account', title: '账号', width:80}
                ,{field: '_name', title: '用户名', width: 90, sort: true, totalRow: true}
                ,{field: 'create_date', title: '创建时间', width: 80, sort: true, totalRow: true}
                ,{field: '_role', title: '角色名', width:150}
