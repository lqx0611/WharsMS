...
<form id="form1" method ="post" >
    <table>
        <tr>
            ...
            <td>
                <select name="repositoryId" id = "repositoryId">
            ...
            <td>
                <button type="button"  onclick="doSubmit();">确定</button>
            </td>
        </tr>
    </table>
</form>
...
<script>
    function doSubmit( ){
        ...
        frm.action = "${ctxPath}/Container/showContainerList2";
        frm.submit();
    }
    var role_data = [
        {text:"请选择角色",val:"0"},
    ...
    layui.use(
        ...
        function(){
            ...
            table.render({
                ...
                ,url: '${ctxPath}/Container/containerList?repositoryId=${sessionScope.repositoryId}'
                ,title: '用户表'
                ,page: true //开启分页
                ...
                ,cols: [[     //设置表头
                    ...
                    ,{field: 'type', title: '货柜类型', width:200}
                    ,{field: 'capacity', title: '货柜容量/吨', width: 200,}
                    ,{field: 'shipType', title: '适用船只类型', width: 200,}
                    ,{field: 'repository', title: '所在仓库', width:200}
